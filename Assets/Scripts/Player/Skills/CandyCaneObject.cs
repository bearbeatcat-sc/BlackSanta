...
namespace Assets.Scripts.Player
{
    internal class CandyCaneObject : MonoBehaviour, IDamagable
    {
        ...
        public void Initialize(CandyCaneSkill.MoveType moveType, Vector2 playerVec,float upSpeed, float fallSpeed, int damage, float knockBackPower)
        {
            m_damage = damage;
            ...
            if (moveType == CandyCaneSkill.MoveType.Drop)
            {
